      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ marginBottom: '60px', textAlign: 'center' }}>
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
            <span className="text-label" style={{ background: 'var(--accent-glow)', color: 'var(--text-primary)', padding: '0.6rem 2rem', borderRadius: '100px', border: '1px solid var(--accent-primary)', fontSize: '0.7rem' }}>
              AGENCY PROTOCOL
            </span>
          </motion.div>
