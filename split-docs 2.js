...
function splitFile(filepath, isForm) {
    ...
    // Add floating download buttons styles inside the head
    const exportStyles = `
    <style>
    ...
    <script>
      function exportDocx(elementId, filename) {
          ...
          var html = header + document.getElementById(elementId).outerHTML + footer;
    ...
    for (let i = 1; i < parts.length; i++) {
        ...
        let pageContent = '<div class="page"' + part;
